        ...
        <div className="grid">
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Matriculas</span>
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    ...
                    <span className="text-green-500 font-medium">24+ alumnos</span>
                    <span className="text-500"> la ultima semana </span>
                </div>
            </div>
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Secciones</span>
                    ...
                    <span className="text-500">nuevos alumnos registrados</span>
                </div>
            </div>
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Sedes</span>
            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    ...
                    <DataTable value={products} rows={5} paginator responsiveLayout="scroll">
                        ...
                        <Column field="price" header="Total Curso" sortable style={{ width: '35%' }} body={(data) => data.price} />
                        <Column
                            header="View"
                            style={{ width: '15%' }}
                            body={() => (
                ...
                <div className="card">
                    ...
                    <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0"> Curso I</span>
                                <div className="mt-1 text-600">Seccion A</div>
                            </div>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Curso II</span>
                                <div className="mt-1 text-600">Seccion A</div>
                            </div>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Curso II</span>
                                <div className="mt-1 text-600">Seccion B</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Curso III</span>
                                <div className="mt-1 text-600">Seccion A</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Curso IV</span>
                                <div className="mt-1 text-600">Seccion A</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
